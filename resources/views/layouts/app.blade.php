...
<head>
    ...
    <meta property="og:title" content={{ $OGtitle?? 'TheRide' }} />
    <meta property="og:image" content="{{ asset('images/main_img.png') }}" />
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-84JHPB1T8D"></script>
    <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-84JHPB1T8D');
    </script>
